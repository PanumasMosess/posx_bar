        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          <div className="relative group flex items-center">
            <button
              ...
              className={`h-8 sm:h-9 px-2.5 rounded-xl border flex items-center gap-2 transition-all active:scale-95 shadow-xs ${activeShift
            ...
            >
              ...
              <span className="relative flex h-2.5 w-2.5">
                <span
                  className={`animate-ping absolute inline-flex h-full w-full rounded-full opacity-75 ${activeShift ? "bg-emerald-400" : "bg-rose-400"
                    }`}
                />
                <span
                  className={`relative inline-flex rounded-full h-2.5 w-2.5 ${activeShift ? "bg-emerald-500" : "bg-rose-500"
                    }`}
                />
              </span>
            ...
            <div className="absolute right-0 top-full mt-2 hidden group-hover:flex flex-col gap-0.5 whitespace-nowrap bg-slate-900 text-white text-[11px] font-medium py-1.5 px-3 rounded-xl shadow-xl z-50 pointer-events-none border border-slate-800 animate-fade-in">
              <div className="flex items-center gap-1.5">
                ...
                <span
                  className={`font-mono font-bold ${activeShift ? "text-emerald-400" : "text-rose-400"
                    }`}
                >
                  {activeShift
          ...
          {/* Middle: Responsive Search Bar (เฉพาะหน้าขาย) */}
          {!isSettings && (
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            {/* Print Receipt Button (เฉพาะหน้าขาย) */}
            {!isSettings && (
              <button
            ...
            {/* Cart Badge Button (เฉพาะหน้าขาย) */}
            {!isSettings && (
              <button

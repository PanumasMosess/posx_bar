export default function Sidebar() {
  return (
    <nav className="hidden md:flex flex-col items-center w-16 lg:w-20 bg-pos-surface border-r border-pos-border py-4 shrink-0 space-y-3 select-none z-20">
      <button className="w-11 lg:w-12 h-11 lg:h-12 rounded-xl bg-gradient-to-br from-sky-600 to-cyan-500 text-white flex flex-col items-center justify-center shadow-md shadow-sky-500/25 group transition active:scale-95">
        <svg className="w-5 h-5 stroke-[2.3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349m-16.5 11.651V9.35m0 0a3.001 3.001 0 003.75-.615A2.993 2.993 0 009 9.35c.694 0 1.343-.238 1.862-.64a3.001 3.001 0 004.276 0A2.993 2.993 0 0017 9.35c.783 0 1.507-.3 2.05-.801a3.001 3.001 0 001.34 2.14" strokeLinecap="round" strokeLinejoin="round"></path>
        </svg>
        <span className="text-[9px] font-bold mt-0.5">ขาย</span>
      </button>
      <button className="w-11 lg:w-12 h-11 lg:h-12 rounded-xl text-slate-400 hover:text-sky-600 hover:bg-sky-50/50 flex flex-col items-center justify-center transition group active:scale-95">
        <svg className="w-5 h-5 stroke-[1.8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" strokeLinecap="round" strokeLinejoin="round"></path>
        </svg>
        <span className="text-[9px] font-medium mt-0.5">รายงาน</span>
      </button>
      <button className="w-11 lg:w-12 h-11 lg:h-12 rounded-xl text-slate-400 hover:text-sky-600 hover:bg-sky-50/50 flex flex-col items-center justify-center transition group active:scale-95">
        <svg className="w-5 h-5 stroke-[1.8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z" strokeLinecap="round" strokeLinejoin="round"></path>
        </svg>
      ...
      <button className="w-11 lg:w-12 h-11 lg:h-12 rounded-xl text-slate-400 hover:text-sky-600 hover:bg-sky-50/50 flex flex-col items-center justify-center transition group active:scale-95">
        ...
        <span className="text-[9px] font-medium mt-0.5">จอครัว</span>
      </button>
      <button className="w-11 lg:w-12 h-11 lg:h-12 rounded-xl text-slate-400 hover:text-sky-600 hover:bg-sky-50/50 flex flex-col items-center justify-center transition group active:scale-95">
        <svg className="w-5 h-5 stroke-[1.8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <span className="text-[9px] font-medium mt-0.5">รายจ่าย</span>
      </button>
      <div className="flex-1"></div>
      <button className="w-11 lg:w-12 h-11 lg:h-12 rounded-xl text-slate-400 hover:text-slate-800 hover:bg-slate-100 flex flex-col items-center justify-center transition group active:scale-95">
        <svg className="w-5 h-5 stroke-[1.8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
